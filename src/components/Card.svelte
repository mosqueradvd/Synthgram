  ...
  <div class="Card-container">
    ...
    <div class="Card-icons">
      <div class="Card-icons-first">
        <i class="fas fa-bolt" class:active-like={like} on:click={handleLike} />
        <i class="fas fa-paper-plane" on:click={handleClicks} />
      </div>
      <div class="Cards-icon-second">
        <i
